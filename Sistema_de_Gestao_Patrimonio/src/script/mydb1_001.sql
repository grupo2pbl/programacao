...
--
-- Host: localhost
-- Generation Time: 24-Out-2014 às 14:58
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `AddEndereco`(IN `Ppais` VARCHAR(45), IN `Ccidade` VARCHAR(45), IN `Nnumero` INT, IN `Rrua` VARCHAR(45))
    NO SQL
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `ListaCargo`()
    NO SQL
select idCargo,designacao from cargo$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `procuraCargo`(IN `idCcargo` INT)
    NO SQL
SELECT idCargo,designacao FROM cargo WHERE idCargo = idCcargo$$
...
ALTER TABLE `compartimento`
 ADD PRIMARY KEY (`idCompartimento`), ADD KEY `fk_Compartimento_TipoCompartimento1` (`TipoCompartimento_idTipoCompartimento`);

--
-- Indexes for table `compartimentoresponsavel`
--
ALTER TABLE `compartimentoresponsavel`
 ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `compartimento`
MODIFY `idCompartimento` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `compartimentoresponsavel`
--
ALTER TABLE `compartimentoresponsavel`
...
--
ALTER TABLE `fornecimento`
MODIFY `idFornecimento` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11513;
--
...
--
ALTER TABLE `material`
MODIFY `idMaterial` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=54;
--
...
--
ALTER TABLE `tipocompartimento`
MODIFY `idTipoCompartimento` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
